...
const Icons = {
    ...
    passthrough: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M5 12h14"/>
...
function renderModelCards(models) {
    return models.map((model, index) => {
        ...
        } else if (apiType === 'passthrough') {
            badges += `<span class="badge badge-passthrough">${Icons.passthrough || ''}Passthrough</span>`;
        }
